...
!(function (e, t) {
  ...
  var ee = {
    ...
    de = {
      init: function () {
        if (this.params.agenda) {
          if (!t.agenda || !t.agenda.pushState)
            return (
              (this.params.agenda.enabled = !1),
          ...
          (e.initialized = !0),
            ...
            (e.paths.key || e.paths.value) &&
              ...
              this.params.agenda.replaceState ||
                t.addEventListener("popstate", this.agenda.setagendaPopState));
        }
      },
      destroy: function () {
        this.params.agenda.replaceState ||
          t.removeEventListener("popstate", this.agenda.setagendaPopState);
      },
      setagendaPopState: function () {
        (this.agenda.paths = de.getPathValues()),
          this.agenda.scrollToSlide(
            this.params.speed,
            this.agenda.paths.value,
            !1
          );
      },
      ...
      setagenda: function (e, i) {
        if (this.agenda.initialized && this.params.agenda.enabled) {
          var s = this.slides.eq(i),
            a = de.slugify(s.attr("data-agenda"));
          t.location.pathname.includes(e) || (a = e + "/" + a);
          var r = t.agenda.state;
          (r && r.value === a) ||
            (this.params.agenda.replaceState
              ? t.agenda.replaceState({ value: a }, null, a)
              : t.agenda.pushState({ value: a }, null, a));
        }
      },
      slugify: function (e) {
        return e
      ...
      scrollToSlide: function (e, t, i) {
        if (t)
          for (var s = 0, a = this.slides.length; s < a; s += 1) {
            ...
            if (
              de.slugify(r.attr("data-agenda")) === t &&
        ...
        if (
          ...
          if (
            ...
            var i = this.slides.eq(this.activeIndex),
              s = i.attr("data-hash") || i.attr("data-agenda");
            e.location.hash = s || "";
          }
      },
      init: function () {
        if (
          !(
            !this.params.hashNavigation.enabled ||
            (this.params.agenda && this.params.agenda.enabled)
          )
        ) {
          ...
          if (i)
            for (var a = 0, r = this.slides.length; a < r; a += 1) {
              ...
              if (
                (n.attr("data-hash") || n.attr("data-agenda")) === i &&
    ...
    ge = [
      ...
      {
        name: "agenda",
        params: { agenda: { enabled: !1, replaceState: !1, key: "slides" } },
        create: function () {
          n.extend(this, {
            agenda: {
              init: de.init.bind(this),
              setagenda: de.setagenda.bind(this),
              setagendaPopState: de.setagendaPopState.bind(this),
        ...
        on: {
          init: function () {
            this.params.agenda.enabled && this.agenda.init();
          },
          destroy: function () {
            this.params.agenda.enabled && this.agenda.destroy();
          },
          transitionEnd: function () {
            this.agenda.initialized &&
              this.agenda.setagenda(this.params.agenda.key, this.activeIndex);
          },
          slideChange: function () {
            this.agenda.initialized &&
              this.params.cssMode &&
